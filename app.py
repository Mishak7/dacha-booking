...
FLOORS = [
    ...
    },
    {
        ...
        "beds": [
            ...
            {"id": "house-2-7", "label": "Дом 2.7", "note": "Тахта для двоих (традиционное место Павла Жука)", "x": 7, "y": 64, "w": 18, "h": 10, "orientation": "horizontal"},
            {"id": "house-2-8", "label": "Дом 2.8", "note": "Этой комнаты боялись даже чеченцы", "x": 7, "y": 80, "w": 18, "h": 10, "orientation": "horizontal"},
            {"id": "house-2-9", "label": "Дом 2.9", "note": "Этой комнаты боялись даже чеченцы", "x": 78, "y": 26, "w": 18, "h": 11, "orientation": "horizontal"},
        ],
    },
    {
        "id": "house-3",
