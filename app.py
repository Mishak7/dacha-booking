...
FLOORS = [
    ...
    },
    {
        ...
        "rooms": [
            {"x": 2, "y": 3, "w": 28, "h": 92, "label": "Левая комната"},
        ...
        "beds": [
            {"id": "house-2-1", "label": "Дом 2.1", "note": "Барская", "x": 6, "y": 50, "w": 6.8, "h": 34, "orientation": "vertical"},
            {"id": "house-2-2", "label": "Дом 2.2", "note": "Барская", "x": 17, "y": 50, "w": 6.8, "h": 34, "orientation": "vertical"},
            {"id": "house-2-3", "label": "Дом 2.3", "note": "Приближенные помещика", "x": 34, "y": 32, "w": 6.8, "h": 34, "orientation": "vertical"},
            {"id": "house-2-4", "label": "Дом 2.4", "note": "Приближенные помещика", "x": 45, "y": 32, "w": 6.8, "h": 34, "orientation": "vertical"},
            {"id": "house-2-5", "label": "Дом 2.5", "note": "Раскладушка (удобная) - можно переставить", "x": 60, "y": 38, "w": 5.2, "h": 25, "orientation": "vertical"},
            {"id": "house-2-6", "label": "Дом 2.6", "note": "Традиционное место Павла Жука (щас там круто)", "x": 78, "y": 10, "w": 18, "h": 11, "orientation": "horizontal"},
        ],
    },
    {
        "id": "house-3",
